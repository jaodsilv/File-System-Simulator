ep3: ep3.o bitmap.o fat.o fildir.o cat.o cp.o exit.o mkdir.o mount.o touch.o umount.o
	gcc -o ep3 ep3.o bitmap.o fat.o fildir.o cat.o cp.o exit.o mkdir.o mount.o touch.o umount.o -lreadline -g
