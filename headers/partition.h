...
#define FILES_AND_SUBDIR 128000                            /*Starting position for files and directories after root*/
...
#define FD_FAT_INDEX           FD_BITMAP_INDEX + 8         /*Index in the FAT table*/
#define FD_FAT_CONTENT         FD_FAT_INDEX + 8            /*Context of FAT in the given index of this block*/
#define FD_FAT_FIRST_INDEX     FD_FAT_CONTENT + 8          /*Initial index for the chain of blocks of this file*/
#define FILE_SIZE              FD_FAT_FIRST_INDEX + 8      /*Size of the file*/
#define FD_NAME                FILE_SIZE + 8               /*Absolute name of the file or directory. Files must have at most 1024 characters*/
#define FD_CDATE               FD_NAME + 1024              /*File/Directory creation date*/
#define FD_MDATE               FD_CDATE + 20               /*File/Directory modified date*/
#define FD_ADATE               FD_MDATE + 20               /*File/Directory access date*/
#define FILE_DATA              FD_ADATE + 20               /*File contents. If doesn't fit, must use another block. Consumes remaining 2884 bytes*/
